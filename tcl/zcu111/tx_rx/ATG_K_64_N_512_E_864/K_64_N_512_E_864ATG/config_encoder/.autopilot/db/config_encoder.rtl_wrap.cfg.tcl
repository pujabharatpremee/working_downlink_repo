...
set DataType1 [list "data_axi_8" "struct data_axi_8" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "dout_words"
set BitWidth2 "16"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType2 [list "data_axi_8" "struct data_axi_8" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
